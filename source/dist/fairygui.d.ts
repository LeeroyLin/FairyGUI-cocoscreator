...
declare module 'fairygui-cc/GRichTextField' {
    import { Color, HorizontalTextAlignment, RichText, SpriteAtlas, SpriteFrame, VerticalTextAlignment } from "cc";
...
declare module 'fairygui-cc/ScrollPane' {
    ...
    export class ScrollPane extends Component {
        ...
        scrollToView2Center(target: any, ani?: boolean): void;
...
declare module 'fairygui-cc/UIConfig' {
    ...
    export class UIConfig {
        ...
        static buttonSoundPlayHandler: (name: string) => void;
